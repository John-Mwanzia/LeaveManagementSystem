Public Class frm_User
    ...
    Private Sub tstripList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            Panel1.BringToFront()
    ...
    Private Sub tstripAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            Panel2.BringToFront()
